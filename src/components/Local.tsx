    ...
    >
      <div className='bg-azul overflow-hidden w-5/6 pb-6 rounded-md flex flex-col items-center'>
        ...
        >
          ...
          <div
            className='rounded-full bg-amarelo text-marinho p-2'
        ...
        <div className='w-full h-[60px] flex justify-center '>
          ...
          <div className='w-[90%] h-full text-zinc-800 overflow-hidden rounded-md mt-2 mb-2  bg-amarelo flex justify-between items-center'>
            <div className='ml-2 flex-1 flex flex-col'>
              <span className='text-1xl'>Residêcia de Sr. Esmael</span>
